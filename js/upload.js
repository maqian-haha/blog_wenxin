class upload{
    constructor(){
        ...
        this.filename="file";
        this.selectBtnStyle="width:100px;height:34px;border-radius:5px;background:orange;margin-bottom:20px;margin-top:20px";
        this.selectBtnCon="请选择";
        this.upBtnStyle="width:100px;height:34px;border-radius:5px;background:#ccc;clear:both;margin-bottom:20px;cursor: pointer";
        this.upBtnCon="点击上传";

        this.pStyle="width:500px;overflow:hidden";
