BUI.use(['bui/grid','bui/data'],function(Grid,Data){
    var
        ...
        columns = [
            {title : '管理员名',dataIndex :'a',editor : {xtype : 'text',validator : validFn}}, //editor中的定义等用于 BUI.Form.Field.Text的定义
            {title : '昵称',dataIndex :'a',editor : {xtype : 'text',validator : validFn}},
            {title : '图片',dataIndex :'a',editor : {xtype : 'text',validator : validFn}},
